...
void DW1000RangingClass::startAsAnchor(char address[], byte anchorNum[], const byte mode[], const bool randomShortAddress) {
	//save the address
	...
	if (randomShortAddress) {
		...
		_currentShortAddress[0] = anchorNum[0];
		_currentShortAddress[1] = anchorNum[1];
	}
	else {
