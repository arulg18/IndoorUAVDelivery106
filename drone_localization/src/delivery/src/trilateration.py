...
def received_sync_data(d0, d1, d2, d3):
    ...
    distances = np.array(
        [[0, 0.59, 1.78, d0.distance - dist_offsets[0]], [3.87, 0.69, 1.53, d1.distance - dist_offsets[1]],
         [3.17, 3.24, 1.66, d2.distance - - dist_offsets[2]], [0, 4.18, 1.70, d3.distance - - dist_offsets[3]]])
